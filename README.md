...
- **Confidential Balances** - Balance encryption for token accounts, plus confidential transfers. Confidential mint/burn is a _separate_, opt-in extension this template does not enable — add it with `withConfidentialMintBurn` (see the [SDK confidential guide](packages/sdk/README.md#confidential-balances--transfers))
...
- **Confidential Balances** (incl. confidential transfers; confidential mint/burn is a separate opt-in extension — see the [SDK confidential guide](packages/sdk/README.md#confidential-balances--transfers))
- **Pausable**
- **Permanent Delegate**
- **Scaled UI Amount**
